...
$routes->get('/shop', 'Public\Dashboard::shop');
...
//bank
$routes->get('bank/read', 'Admin\Bank\Read::index');
$routes->get('bank/update/(:num)',    'Admin\bank\Update::index/$1');
$routes->post('bank/update/(:num)',    'Admin\bank\Update::Action_Update/$1');
//iklan
