...
class Create extends BaseController
{
    ...
    public function index()
    {
        ...
        $validationRules = [
            ...
            'nama_produk' => 'required|alpha_numeric_punct|max_length[50]|is_unique[produk.nama_produk]',
        ...
        $validationMessages = [
            ...
            'nama_produk' => [
                'required' => 'Kolom Harus Terisi',
                'max_length' => 'Kolom tidak boleh lebih dari 50 huruf',
        ...
        if ($gambarProduk->getSize() > 25 * 1024 * 1024) { // 2 MB in bytes
            return redirect()->to('admin/produk/create')->with('error', 'Ukuran file harus kurang dari 25 MB.');
        }
