...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Iklan</h1>
    <a href="<?= base_url('admin/iklan/read') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Kumpulan Iklan</a>
</div>
